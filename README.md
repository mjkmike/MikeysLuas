...
and  https://github.com/GetAwayCoxn/Luashitacast-Profiles

99% of this is rags work and I'm modifying what he has out there.  Please look at https://github.com/yzyii/luashitacast For latest horizon lua updates
...
- Rename the Mikey_171 folder to [Your_Character_Name]_[Your_Character_ID]
...
- Edit Aketons and Dream gear etc. and turn on or off additional logging in gcinclude.lua.
...
```
/tpset /tp /mode - Cycles TP set between a LowAcc, MidAcc and HighAcc set.
